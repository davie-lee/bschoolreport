<template>
  <div>
    <vue-headful
      title="MBA Employment Reports - Duke University, Fuqua School of Business"
      description="Free resource for prospective MBA students"
    />
    <Selector/>
    <!-- Charts -->
    <div class="container">
      <h1 class="title is-4">Duke University, Fuqua School of Business</h1>
      <div class="columns">
        <Industry collegeref="fuqua"/>
        <IndustryPercent collegeref="fuqua"/>
      </div>
      <div class="columns">
        <Function collegeref="fuqua"/>
        <FunctionPercent collegeref="fuqua"/>
      </div>
      <div class="columns">
        <FinanceBreakdown collegeref="fuqua"/>
        <JobLocation collegeref="fuqua"/>
      </div>
      <div class="columns">
        <Employment collegeref="fuqua"/>
        <MajorEmployer collegeref="fuqua"/>
      </div>
      <div class="columns">
        <Profile collegeref="fuqua"/>
        <Women collegeref="fuqua"/>
      </div>
      <div class="columns">
        <AverageAge collegeref="fuqua"/>
        <AverageGMAT collegeref="fuqua"/>
      </div>
      <div class="columns">
        <AvgWorkWE collegeref="fuqua"/>
        <AverageGPA collegeref="fuqua"/>
      </div>
      <div class="columns">
        <InternationalStudents collegeref="fuqua"/>
        <Countries collegeref="fuqua"/>
      </div>
    </div>
  </div>
</template>
