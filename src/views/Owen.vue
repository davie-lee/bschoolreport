<template>
  <div>
    <vue-headful
      title="MBA Employment Reports - Vanderbilt University, Owen Graduate School of Management"
      description="Free resource for prospective MBA students"
    />
    <Selector/>
    <!-- Charts -->
    <div class="container">
      <h1 class="title is-4">Vanderbilt University, Owen Graduate School of Management</h1>
      <div class="columns">
        <Industry collegeref="owen"/>
        <IndustryPercent collegeref="owen"/>
      </div>
      <div class="columns">
        <Function collegeref="owen"/>
        <FunctionPercent collegeref="owen"/>
      </div>
      <div class="columns">
        <FinanceBreakdown collegeref="owen"/>
        <JobLocation collegeref="owen"/>
      </div>
      <div class="columns">
        <Employment collegeref="owen"/>
        <MajorEmployer collegeref="owen"/>
      </div>
      <div class="columns">
        <Profile collegeref="owen"/>
        <Women collegeref="owen"/>
      </div>
      <div class="columns">
        <AverageAge collegeref="owen"/>
        <AverageGMAT collegeref="owen"/>
      </div>
      <div class="columns">
        <AvgWorkWE collegeref="owen"/>
        <AverageGPA collegeref="owen"/>
      </div>
      <div class="columns">
        <InternationalStudents collegeref="owen"/>
        <Countries collegeref="owen"/>
      </div>
    </div>
  </div>
</template>
