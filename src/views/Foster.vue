<template>
  <div>
    <vue-headful
      title="MBA Employment Reports - University of Washington, Foster School of Business"
      description="Free resource for prospective MBA students"
    />
    <Selector/>
    <!-- Charts -->
    <div class="container">
      <h1 class="title is-4">University of Washington, Foster School of Business</h1>
      <div class="columns">
        <Industry collegeref="foster"/>
        <IndustryPercent collegeref="foster"/>
      </div>
      <div class="columns">
        <Function collegeref="foster"/>
        <FunctionPercent collegeref="foster"/>
      </div>
      <div class="columns">
        <FinanceBreakdown collegeref="foster"/>
        <JobLocation collegeref="foster"/>
      </div>
      <div class="columns">
        <Employment collegeref="foster"/>
        <MajorEmployer collegeref="foster"/>
      </div>
      <div class="columns">
        <Profile collegeref="foster"/>
        <Women collegeref="foster"/>
      </div>
      <div class="columns">
        <AverageAge collegeref="foster"/>
        <AverageGMAT collegeref="foster"/>
      </div>
      <div class="columns">
        <AvgWorkWE collegeref="foster"/>
        <AverageGPA collegeref="foster"/>
      </div>
      <div class="columns">
        <InternationalStudents collegeref="foster"/>
        <Countries collegeref="foster"/>
      </div>
    </div>
  </div>
</template>
