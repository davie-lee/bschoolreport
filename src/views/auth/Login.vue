<template>
   ...
   <div class="login-card">
      ...
      <div class="content">
         ...
         <input id="email" v-model="email" type="email" name="email" title="email" placeholder="Email" required autofocus>
         <input id="password" v-model="password" type="password" name="password" title="password" placeholder="Password" required>
         <button @click="emailLogin({email: email, password: password})" class="login btn btn-primary">Sign in with email</button>
         ...
         <button @click="facebookLogin()" type="button" class="provider-button">
            <span class="provider-button__icon">
               <svg viewBox="0 0 266 272" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px"  enable-background="new 0 0 266.893 266.895" xml:space="preserve">
         ...
         <div class="level options signup-suggest">
            <router-link tag="a" class=" btn btn-link level-right" to="/signup">Don't have an account? Sign up here</router-link>
         </div>
      </div>
   </div>
</div>
