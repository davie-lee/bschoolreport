<template>
  <div>
    <vue-headful
      title="MBA Employment Reports - Northwestern University, Kellogg School of Management"
      description="Free resource for prospective MBA students"
    />
    <Selector/>
    <!-- Charts -->
    <div class="container">
      <h1 class="title is-4">Northwestern University, Kellogg School of Management</h1>
      <div class="columns">
      ...
      <div class="columns">
        ...
        <MajorEmployer collegeref="kellogg"/>
      </div>
      <div class="columns">
