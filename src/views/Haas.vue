<template>
  <div>
    <vue-headful
      title="MBA Employment Reports - Berkeley, Haas School of Business"
      description="Free resource for prospective MBA students"
    />
    <Selector/>
    <!-- Charts -->
    <div class="container">
      <h1 class="title is-4">Berkeley, Haas School of Business</h1>
      <div class="columns">
        <Industry collegeref="haas"/>
        <IndustryPercent collegeref="haas"/>
      </div>
      <div class="columns">
        <Function collegeref="haas"/>
        <FunctionPercent collegeref="haas"/>
      </div>
      <div class="columns">
        <FinanceBreakdown collegeref="haas"/>
        <JobLocation collegeref="haas"/>
      </div>
      <div class="columns">
        <Employment collegeref="haas"/>
        <MajorEmployer collegeref="haas"/>
      </div>
      <div class="columns">
        <Profile collegeref="haas"/>
        <Women collegeref="haas"/>
      </div>
      <div class="columns">
        <AverageAge collegeref="haas"/>
        <AverageGMAT collegeref="haas"/>
      </div>
      <div class="columns">
        <AvgWorkWE collegeref="haas"/>
        <AverageGPA collegeref="haas"/>
      </div>
      <div class="columns">
        <InternationalStudents collegeref="haas"/>
        <Countries collegeref="haas"/>
      </div>
    </div>
  </div>
</template>
