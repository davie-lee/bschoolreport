<template>
  <div>
    <vue-headful
      title="MBA Employment Reports - University of Minnesota, Carlson School of Management"
      description="Free resource for prospective MBA students"
    />
    <Selector/>
    <!-- Charts -->
    <div class="container">
      <h1 class="title is-4">University of Minnesota, Carlson School of Management</h1>
      <div class="columns">
        <Industry collegeref="carlson"/>
        <IndustryPercent collegeref="carlson"/>
      </div>
      <div class="columns">
        <Function collegeref="carlson"/>
        <FunctionPercent collegeref="carlson"/>
      </div>
      <div class="columns">
        <FinanceBreakdown collegeref="carlson"/>
        <JobLocation collegeref="carlson"/>
      </div>
      <div class="columns">
        <Employment collegeref="carlson"/>
        <MajorEmployer collegeref="carlson"/>
      </div>
      <div class="columns">
        <Profile collegeref="carlson"/>
        <Women collegeref="carlson"/>
      </div>
      <div class="columns">
        <AverageAge collegeref="carlson"/>
        <AverageGMAT collegeref="carlson"/>
      </div>
      <div class="columns">
        <AvgWorkWE collegeref="carlson"/>
        <AverageGPA collegeref="carlson"/>
      </div>
      <div class="columns">
        <InternationalStudents collegeref="carlson"/>
        <Countries collegeref="carlson"/>
      </div>
    </div>
  </div>
</template>
