<template>
  <div>
    <vue-headful
      title="MBA Employment Reports - Cornell Johnson Graduate School of Management"
      description="Free resource for prospective MBA students"
    />
    <Selector/>
    <!-- Charts -->
    <div class="container">
      <h1 class="title is-4">Cornell Johnson Graduate School of Management</h1>
      <div class="columns">
      ...
      <div class="columns">
        ...
        <MajorEmployer collegeref="johnson"/>
      </div>
      <div class="columns">
