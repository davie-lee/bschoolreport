<template>
  <div>
    <vue-headful
      title="MBA Employment Reports - University of Virginia, Darden School of Business"
      description="Free resource for prospective MBA students"
    />
    <Selector/>
    <!-- Charts -->
    <div class="container">
      <h1 class="title is-4">University of Virginia, Darden School of Business</h1>
      <div class="columns">
        <Industry collegeref="darden"/>
        <IndustryPercent collegeref="darden"/>
      </div>
      <div class="columns">
        <Function collegeref="darden"/>
        <FunctionPercent collegeref="darden"/>
      </div>
      <div class="columns">
        <FinanceBreakdown collegeref="darden"/>
        <JobLocation collegeref="darden"/>
      </div>
      <div class="columns">
        <Employment collegeref="darden"/>
        <MajorEmployer collegeref="darden"/>
      </div>
      <div class="columns">
        <Profile collegeref="darden"/>
        <Women collegeref="darden"/>
      </div>
      <div class="columns">
        <AverageAge collegeref="darden"/>
        <AverageGMAT collegeref="darden"/>
      </div>
      <div class="columns">
        <AvgWorkWE collegeref="darden"/>
        <AverageGPA collegeref="darden"/>
      </div>
      <div class="columns">
        <InternationalStudents collegeref="darden"/>
        <Countries collegeref="darden"/>
      </div>
    </div>
  </div>
</template>
