<template>
  <div>
    <vue-headful
      title="MBA Employment Reports - Indiana University, Kelley School of Business"
      description="Free resource for prospective MBA students"
    />
    <Selector/>
    <!-- Charts -->
    <div class="container">
      <h1 class="title is-4">Indiana University, Kelley School of Business</h1>
      <div class="columns">
        <Industry collegeref="kelley"/>
        <IndustryPercent collegeref="kelley"/>
      </div>
      <div class="columns">
        <Function collegeref="kelley"/>
        <FunctionPercent collegeref="kelley"/>
      </div>
      <div class="columns">
        <FinanceBreakdown collegeref="kelley"/>
        <JobLocation collegeref="kelley"/>
      </div>
      <div class="columns">
        <Employment collegeref="kelley"/>
        <MajorEmployer collegeref="kelley"/>
      </div>
      <div class="columns">
        <Profile collegeref="kelley"/>
        <Women collegeref="kelley"/>
      </div>
      <div class="columns">
        <AverageAge collegeref="kelley"/>
        <AverageGMAT collegeref="kelley"/>
      </div>
      <div class="columns">
        <AvgWorkWE collegeref="kelley"/>
        <AverageGPA collegeref="kelley"/>
      </div>
      <div class="columns">
        <InternationalStudents collegeref="kelley"/>
        <Countries collegeref="kelley"/>
      </div>
    </div>
  </div>
</template>
