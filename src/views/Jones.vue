<template>
  <div>
    <vue-headful
      title="MBA Employment Reports - Rice University, Jones Graduate School of Business"
      description="Free resource for prospective MBA students"
    />
    <Selector/>
    <!-- Charts -->
    <div class="container">
      <h1 class="title is-4">Rice University, Jones Graduate School of Business</h1>
      <div class="columns">
        <Industry collegeref="jones"/>
        <IndustryPercent collegeref="jones"/>
      </div>
      <div class="columns">
        <Function collegeref="jones"/>
        <FunctionPercent collegeref="jones"/>
      </div>
      <div class="columns">
        <FinanceBreakdown collegeref="jones"/>
        <JobLocation collegeref="jones"/>
      </div>
      <div class="columns">
        <Employment collegeref="jones"/>
        <MajorEmployer collegeref="jones"/>
      </div>
      <div class="columns">
        <Profile collegeref="jones"/>
        <Women collegeref="jones"/>
      </div>
      <div class="columns">
        <AverageAge collegeref="jones"/>
        <AverageGMAT collegeref="jones"/>
      </div>
      <div class="columns">
        <AvgWorkWE collegeref="jones"/>
        <AverageGPA collegeref="jones"/>
      </div>
      <div class="columns">
        <InternationalStudents collegeref="jones"/>
        <Countries collegeref="jones"/>
      </div>
    </div>
  </div>
</template>
